...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            header("location: /ShoeProject_1/index.php");
        } else {
        ...
        <div class="d-md-flex justify-content-between align-items-center">
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="inquirySubject" class="form-control" value="" size ="50" required>
                </div>
                <div class="form-group">
                    <label>Inquiry Message</label>
                    <textarea class="form-control" rows="4" cols="30" name="message"value="" size ="50" required></textarea>
