	...
	<div class="container-fluid">
		...
		<div class="row flex-nowrap">
			...
			<div class="container-fluid my-4 w-75">
				<div class="row my-2">
					<h2> Shop - Orders</h2>
					<a href="orders.php"><button type="button" class="btn btn-primary ml-4 pl-2">Add New</button></a>
				</div>
				<table class="table ">
					<thead>
						<tr>
					...
					<tbody>
						...
						?>
								<tr>
									...
									<td>
										<a href="#"><button type="button" class="btn btn-info">In progress</button></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<a href="#"><button type="button" class="btn btn-danger"> Yes, Delete</button></a>
      </div>
